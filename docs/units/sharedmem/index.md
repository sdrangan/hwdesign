...
In the previous unit on [loop optimization](/hwdesign/loopopt/), we built and optimized a simple vector multiplier IP core.
...
Go to [Creating the Vitis IP](./vitisip.md).
